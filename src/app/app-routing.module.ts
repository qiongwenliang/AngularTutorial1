...
{path:"employee-edit/:id", component: EditEmployeeComponent},//this is a dynamic url, it change with the value of id
...
@NgModule({
  imports: [RouterModule.forRoot(routes)], //forRoot is eager loading, there's also lazy loading
